...
4. В терминале VSC командой был создан локальный репозиторий проек
5. Cоздание блок-схемы решения задачи
<image src="/Users/ekaterinagordienko/Desktop/kontr/схема.jpg">
6. Написание кода на C#

7. После каждого шага выполнялась отправка промежуточных коммитов в удаленный репозиторий командами